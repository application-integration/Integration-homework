...
from MySpider.items import TaopiaoFilm
from MySpider.items import TaopiaoFilmScreenings
...
class taopiaoSpider(scrapy.Spider):
    ...
    def parse_movie(self, response):
        ...
        for index, li in enumerate(flexslider):
            ...
            movie_id_map = li.xpath('.//a[@class="movie-card-buy"]//@data-data | .//a[@class="buy"]//@data-data').extract_first()
